...
def smearing(month, plot=False):
    ...
    if plot:
        ...
        pp.createmap(f_hcho.T,lats,lons,latlon=True,edges=False,linear=True,pname=pname,title='f_hcho')
        # lie about edges...
        pp.createmap(S.T,lats_e[::-1],lons_e[::-1], latlon=True, edges=True, region=region, linear=True,
