...
hfires=util.regrid(fires,lats,lons,hlats,hlons)
lfires=util.regrid(fires,lats,lons,llats,llons)
...
plt.sca(axes[2])
pp.createmap(lfires,llats,llons,title='Low res',
             colorbar=None, pname='test_fires.png',
             linear=False,cmapname='Reds',vmin=1,vmax=3e6)
#
