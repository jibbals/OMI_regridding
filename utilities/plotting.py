...
if __name__=='__main__':
    ...
    plt.figure()
    plt.subplot(121)
    plot_swath(datetime(2005,1,9),title="2005, Jan, 9",
               cmapname='inferno',linear=True)
    print('half done')
    plt.subplot(122)
    plot_swath(datetime(2005,1,9),title="Eight Days", oneday=False,
               pname="Figs/Checks/example_swaths.png",
               cmapname='inferno', linear=True)
    print('done')
